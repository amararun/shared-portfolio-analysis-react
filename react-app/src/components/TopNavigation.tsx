      ...
      <div className="px-3 py-1.5 bg-white">
        ...
        <div className="flex flex-col w-full md:hidden">
          <div className="flex items-center justify-center w-full mb-2">
            <span className="text-indigo-900 font-semibold text-base text-center">TIGZIG Quants Stats, Fin & AI Technicals</span>
          </div>
        ...
        <div className="hidden md:flex items-center justify-between">
          <span className="text-indigo-900 font-semibold text-base">TIGZIG Quants: Stats, Fin & AI Technicals</span>
                ...
                <div className="space-y-4">
                  <div className="space-y-4">
                    ...
                    <div>
                      <h3 className="text-base font-medium text-gray-800 mb-2">User Interface Repository</h3>
                      <p className="text-gray-600 text-sm mb-2">
                        The user interface is React with the agent in N8N connected to backend MCP servers and link below has got the user interface code as well as the N8N schemas.
                      </p>
                      <a href="https://rex.tigzig.com/mcp-quantstats-agent" 
                         target="_blank" 
                         rel="noopener noreferrer"
